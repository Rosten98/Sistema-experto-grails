...
<html>
    ...
    <body>
        ...
        <div id="show-statement" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.statement}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.statement}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
